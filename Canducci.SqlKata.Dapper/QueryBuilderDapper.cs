...
namespace Canducci.SqlKata.Dapper
{
    public partial class QueryBuilderDapper : QueryBuilder, IDisposable
    {
        ...
        public int Execute(IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            ...
            return connection.Execute(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }

        public Task<int> ExecuteAsync(IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            SqlResult result = Compiler();
            return connection.ExecuteAsync(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.Query(result.Sql, map, result.NamedBindings, transaction, buffered, splitOn, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.Query(result.Sql, result.NamedBindings, transaction, buffered, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.Query(result.Sql, types, map, result.NamedBindings, transaction, buffered, splitOn, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.Query(type, result.Sql, result.NamedBindings, transaction, buffered, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.QueryAsync(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.QueryAsync(result.Sql, map, result.NamedBindings, transaction, buffered, splitOn, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.QueryAsync(result.Sql, types, map, result.NamedBindings, transaction, buffered, splitOn, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.QueryAsync(type, result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.QueryAsync<T>(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }

        public dynamic QueryFirst(IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            SqlResult result = Compiler();
            return connection.QueryFirst(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }

        public object QueryFirst(Type type, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            SqlResult result = Compiler();
            return connection.QueryFirst(type, result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }

        public T QueryFirst<T>(IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            SqlResult result = Compiler();
            return connection.QueryFirst<T>(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.QueryFirstAsync(type, result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }

        public Task<T> QueryFirstAsync<T>(IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            SqlResult result = Compiler();
            return connection.QueryFirstAsync<T>(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.QueryFirstOrDefault(type, result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }

        public dynamic QueryFirstOrDefault(IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            SqlResult result = Compiler();
            return connection.QueryFirstOrDefault(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.QueryFirstOrDefaultAsync(type, result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.QueryFirstOrDefaultAsync<T>(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.QueryMultipleAsync(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }

        public dynamic QuerySingle(IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            SqlResult result = Compiler();
            return connection.QuerySingle(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }

        public object QuerySingle(Type type, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            SqlResult result = Compiler();
            return connection.QuerySingle(type, result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }

        public T QuerySingle<T>(IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            SqlResult result = Compiler();
            return connection.QuerySingle<T>(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }

        public Task<T> QuerySingleAsync<T>(IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            SqlResult result = Compiler();
            return connection.QuerySingleAsync<T>(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.QuerySingleAsync(type, result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }

        public T QuerySingleOrDefault<T>(IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            SqlResult result = Compiler();
            return connection.QuerySingleOrDefault<T>(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.QuerySingleOrDefaultAsync(type, result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }
        ...
        {
            SqlResult result = Compiler();
            return connection.QuerySingleOrDefaultAsync<T>(result.Sql, result.NamedBindings, transaction, commandTimeout, commandType);
        }
